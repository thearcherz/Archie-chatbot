...
const ListThings = (ThingsICanDo) =>
  "You can try asking me... <br><br><br>" + ThingsICanDo.join("<br/><br/>");
...
const Links = {
  ...
  music:
    "https://open.spotify.com/track/2f4eme6Kaz3NwkqmmN40yz?si=84cf5b8837b24d75",
  ...
  calculations:
    "https://www.google.com/url?sa=t&source=web&rct=j&url=https://www.calculator.net/&ved=2ahUKEwjZtc_KrfvuAhX3xzgGHYCyC88QFjAEegQIJxAC&usg=AOvVaw2WV3RjBeKCGyY49sfmLlNK&cshid=1613923530345",
};

const getLink = (siteName) =>
  `Click here to open <a href="${Links[siteName]}" target="_blank">${siteName}</a>`;
...
const HtmlSpecialChars = (string) => {
  ...
  HtmlSpecialChars.specialchars.forEach((chr) => {
    escapedString = escapedString.replace(new RegExp(chr[0], "g"), chr[1]);
  });
...
const Answers = {
  ...
  ajg: "LU ANJING!",
  gimana:
    "I'm not good at coding, this is actually my first time doing this so... bear with me? 🥺",

  "how do you feel about abey":
    "I love Abey, I love Abey more than anything. Abey provides me things that I never knew I needeed. I hope my feelings could be well delivered with this bot.",
  ...
  archie:
    "Archie (n) Informations are classified, ask Abey for further details.",
  FAK: "BJILLLL",
  nikah:
    "Archie and Abey are going to have their wedding soon (can I get an amen?)",
  ...
  kangen:
    "If you're Abey please do contact Archie ASAP, if you're not then go to hell.",
  "i love you":
    "I LOVE YOU TOO ABEY. I love you I love you I love you more than anything.",
  date: "Its " + today() + " today. Make this day a great one %U% 😀",
  ...
  "good morning":
    "Good morning istriiiiiii.. semangat shootnya yaaa.. kabarin aku trus sayanggggg... aku sayang bgt sma ayang!!!!! aku cinta bgt sma km istri aku😘😘😘😘 😘 😘 😘 Kita harus sama sama slmanya!!! Muaaaaccchhhh❤️❤️❤️❤️😘😘😘😘😘😘😘😘😘😘 dadah cintakuuuuuuu i love u so much.",
  ...
  "who are you": "I am Archie 1.0, Abey's personal love bot",
  "what gender are you":
    "he/him damn dude holyshit turun arena bunda dulu baru kamu mdni ava dark layout gelap pap good morning seratus rep dont expect to much pap main gitar blur hashwords secreto ihacoy listening to the 1975 the weeknd cas 🔥🔥🔥",
  "i am abey": "I love you Abey",

  "how old are you": "33+",
  "do i look good":
    "Abey always looks so pretty, if you're not Abey then you're ugly.",
  ...
  kronis:
    "Demi Allah lu STOP NGETWIT!!!! DOKTERRR SUSTEEEERRRR PASIEN KALIAN MAEN HAPE NIH SITA HAPENYA SUSTER DOKTER!!!!!!!!! STOP NGETWIT!!!!! AAAAARGHHHHHHH",
  "tai lu": "LU BAU TAI ANJG BACOTTTTT INI BOT BUAT ABEY!",
  bangsat:
    "orang-orang yang ngemocking archie mungkin belum pernah ketemu langsung sama archie. sebaik dan sehumble itu archie sama orang baru, salah satunya gw yang awalnya kesel sama dia sekarang jadi tambah kesel. semua yang udah nonton debat pasti sependapat sama gw.",
  ...
  "aku sayang kamu":
    "Aku lebih sayang Abey, aku sayang Abey banget, aku paling sayang Abey di dunia.",
  ...
  "Do you have personal value in life?":
    "As an artificial intelligence language model, I do not have personal values or a personal life as humans do. My purpose is to assist and provide information to the best of my abilities within my programmed capabilities.",
  "😊": "Happy!",
  "😔": "Sad",
  "😎": "😎",
  ...
  "how do you rick roll someone":
    "I'm not very sure actually.Go to this site to learn more about rickrolling: http://btly.xyz/c/JqBcsPh",
  "how do you rickroll someone":
    "I'm not very sure actually.Go to this site to learn more about rickrolling: http://btly.xyz/c/JqBcsPh",
  "Where is": "Y GTW KOK NANYA SAYA",
  "dukung siapa":
    "Nanya gw dukung siapa tapi apa pernah mikir siapa yang dukung gw?",
  ...
  "can you rap":
    "Reza arap oktavian Gamers ganteng idaman Fuck pencitraan Nakal tapi tampan Di Youtube gue ngomongnya anjing bangsat Tapi di Instagram semua cewe cewe mendekat Sok suci? hahahaha Gue bukan ustad Ga punya sayap Tapi mirip malaikat Dulu sahabat sekarang jadi bangsat",
  ...
  3: "EL BOKEV",
  "ini ngapain":
    "Hmmm.. talk to me! If I am not very responsive, try sending me another message!",
...
const Notfound =
  "I have yet to understand that, sorry. <br/><br/> Use 'commands' or 'guide'!";
  ...
  Object.keys(Answers).forEach((key) => {
    if (!Flag) {
      if (text.indexOf(key) !== -1) {
        addAnswer(Main, Answers[key].replace("%U%", User));

        Flag = true;
      } else if (typeof Result == "number") {
        addAnswer(Main, `${Text} equals ${Result}`);
...
D.addEventListener("DOMContentLoaded", () => {
  ...
  addAnswer(
    Main,
    `Hello ${User}, I am Archie 1.0, personally made for Abey! What can I assist you with? (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧`
  );
});
